...
impl SystemSet {
    ...
    pub fn on_inactive_update<T>(s: T) -> Self
    where
        T: StateData,
    {
    ...
    pub fn on_in_stack_update<T>(s: T) -> Self
    where
        T: StateData,
    {
