...
use lgn_ecs_macros::{all_tuples, impl_param_set};
use lgn_ptr::UnsafeCellDeref;
...
/// ```
/// # use lgn_ecs::prelude::*;
/// # use lgn_ecs::system::assert_is_system;
/// struct Config(u32);
...
///
/// If you are using `lgn_ecs` as a standalone crate,
/// note that the `RemovedComponents` list will not be automatically cleared for you,
/// and will need to be manually flushed using [`World::clear_trackers`]
///
/// For users of `legion` itself, this is automatically done in a system added by `MinimalPlugins`
...
/// ```
/// # use lgn_ecs::prelude::*;
/// use lgn_ecs::system::{SystemParam, StaticSystemParam};
/// #[derive(SystemParam)]
...
///     lgn_ecs::system::assert_is_system(do_thing_generically::<T>);
/// }
/// ```
...
impl<'world, 'state, S: SystemParamFetch<'world, 'state>, P: 'static>
