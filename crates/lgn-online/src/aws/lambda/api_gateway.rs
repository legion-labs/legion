...
///
/// ```rust
/// use lgn_online::aws::lambda::api_gateway::{APIGatewayBaseMethodArn, APIGatewayMethodArn, Method};
///
...
///
/// ```rust
/// use lgn_online::aws::lambda::api_gateway::Method;
///
...
///
/// ```
/// use lgn_online::aws::lambda::api_gateway::{APIGatewayBaseMethodArn, APIGatewayPolicyBuilder};
///
/// let base_method_arn = APIGatewayBaseMethodArn{
///     region: "us-east-1".to_string(),
///     aws_account_id: "123456789012".to_string(),
