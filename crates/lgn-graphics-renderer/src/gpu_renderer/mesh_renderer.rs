...
impl MeshRenderer {
        ...
        cmd_buffer.with_label(
            ...
            |cmd_buffer| {
                ...
                culling_descriptor_set
                    .set_culling_efficiency(culling_buffers.stats_buffer.rw_view());
    ...
    pub(crate) fn gen_occlusion_and_cull(
        ...
        cmd_buffer.with_label(
            ...
            |cmd_buffer| {
                ...
                let gpu_instance_view = gpu_instance_allocation.create_structured_buffer_view(
                    std::mem::size_of::<GpuInstanceData>() as u64,
                    true,
                );
                ...
                let render_pass_view = render_pass_allocation.create_structured_buffer_view(
                    std::mem::size_of::<RenderPassData>() as u64,
                    true,
                );
    ...
    pub(crate) fn draw(
        ...
        cmd_buffer.with_label(render_context.renderer().device_context(), &label, |cmd_buffer| {
