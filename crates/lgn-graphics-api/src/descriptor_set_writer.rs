use crate::{DescriptorRef, DescriptorSetHandle, DescriptorSetLayout, DeviceContext};
...
impl<'a> DescriptorSetWriter<'a> {
    ...
    pub fn set_descriptors(
        ...
        self.backend_set_descriptors(device_context, descriptor_refs);
    ...
    // pub fn flush(self) -> DescriptorSetHandle {
