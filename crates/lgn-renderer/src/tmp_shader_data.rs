...
//     pub const ID: CGenShaderID = CGenShaderID::make(this_cgen::ID, 2);
...
//     pub const ID: CGenShaderID = CGenShaderID::make(this_cgen::ID, 3);
...
//     pub const ID: CGenShaderID = CGenShaderID::make(this_cgen::ID, 4);
