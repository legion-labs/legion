...
#define PIPELINE_LAYOUT_PICKINGPIPELINELAYOUT
    ...
    // - freq: 2
    #include "crate://lgn-renderer/codegen/hlsl/descriptor_set/picking_descriptor_set.hlsl"

    // PushConstant
    // - name: push_constant
    #include "crate://lgn-renderer/codegen/hlsl/cgen_type/picking_push_constant_data.hlsl"
