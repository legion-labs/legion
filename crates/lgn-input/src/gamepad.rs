...
/// Monitors gamepad connection and disconnection events, updating the
/// [`Gamepads`] resource accordingly
///
/// By default, runs during `CoreStage::PreUpdate` when added via
/// [`crate::InputPlugin`].
