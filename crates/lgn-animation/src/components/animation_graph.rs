...
use crate::runtime_graph::nodes_state_condition::node_state_completed_condition::StateCompletedConditionNode;
...
impl GraphDefinition {
    ...
    pub fn new(state_machine: &EditorGraphDefinition) -> Self {
        ...
        for state in &state_machine.states {
            let current_clip = AnimationClip::new(&state.track, &mut skeletons);
            ...
            let transitions = vec![TransitionInfo {
                ...
                condition_node: Box::new(StateCompletedConditionNode {
                    key_events: vec![KeyCode::Left, KeyCode::Up, KeyCode::Right, KeyCode::Down],
                }),
            }];
