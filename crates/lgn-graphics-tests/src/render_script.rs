use crate::{
    render_graph::{
        ColorOrDepthClearValue, RenderGraph, RenderGraphResourceDef, RenderGraphResourceId,
...
use lgn_graphics_api::{
    ColorClearValue, Format, GfxError, GfxResult, PlaneSlice, Texture, ViewDimension,
};
...
impl RenderScript {
    ...
    pub fn build_render_graph(
        ...
        let single_mip_read_only_view_def = self.make_single_mip_read_only_view_def();
        let single_mip_read_only_view_id =
            rendergraph_builder.declare_view(&single_mip_read_only_view_def);
    ...
    #[allow(clippy::unused_self)]
    fn make_single_mip_read_only_view_def(&self) -> RenderGraphViewDef {
        RenderGraphViewDef::Texture(RenderGraphTextureViewDef {
            view_dimension: ViewDimension::_2D,
            first_mip: 0,
            mip_count: 1,
