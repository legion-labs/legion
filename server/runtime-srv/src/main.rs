...
fn main() {
    ...
    let root_asset = args
        ...
        .unwrap_or("(1d9ddd99aad89045,af7e6ef0-c271-565b-c27a-b8cd93c3546a)"); // should map to the runtime_entity generated by (1c0ff9e497b0740f,45d44b64-b97c-486d-a0d7-151974c28263)|1d9ddd99aad89045 -- check output.index
