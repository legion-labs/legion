...
pub fn derive_component(input: TokenStream) -> TokenStream {
    ...
    let legion_ecs_path: Path = crate::legion_ecs_path();
    ...
    let storage = storage_path(&legion_ecs_path, attrs.storage);
    ...
    TokenStream::from(quote! {
        impl #impl_generics #legion_ecs_path::component::Component for #struct_name #type_generics #where_clause {
...
fn storage_path(legion_ecs_path: &Path, ty: StorageTy) -> TokenStream2 {
    ...
    quote! { #legion_ecs_path::component::#typename }
}
