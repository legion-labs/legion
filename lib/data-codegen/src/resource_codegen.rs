    ...
    quote! {
        ...
        impl AssetLoader for #offline_identifier_processor {
            fn load(&mut self, reader: &mut dyn io::Read) -> io::Result<Box<dyn Any + Send + Sync>> {
                ...
                lgn_data_reflection::json_utils::reflection_apply_json_edit::<#offline_identifier>(&mut instance, &values)
                    .map_err(|_err| std::io::Error::new(std::io::ErrorKind::InvalidData, "invalid json"))?;
                Ok(Box::new(instance))
            }
        ...
        impl ResourceProcessor for #offline_identifier_processor {
            ...
            fn write_resource(&mut self, resource: &dyn Any, writer: &mut dyn std::io::Write) -> std::io::Result<usize> {
                ...
                let values = lgn_data_reflection::json_utils::reflection_save_relative_json(instance, #offline_identifier::get_default_instance()).
                    map_err(|_err| std::io::Error::new(std::io::ErrorKind::InvalidData, "invalid json"))?;
            ...
            fn get_resource_reflection<'a>(&self, resource: &'a dyn Any) -> Option<&'a dyn lgn_data_reflection::TypeReflection> {
            ...
            fn get_resource_reflection_mut<'a>(&self, resource: &'a mut dyn Any) -> Option<&'a mut dyn lgn_data_reflection::TypeReflection> {
