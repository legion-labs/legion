...
impl App {
    ...
    pub fn update(&mut self) {
        #[cfg(feature = "trace")]
        let frame_update_span = info_span!("frame");
        #[cfg(feature = "trace")]
        let _frame_update_guard = frame_update_span.enter();
        trace_scope!("frame");
    ...
    pub fn run(&mut self) {
        #[cfg(feature = "trace")]
        let app_run_span = info_span!("legion_app");
        #[cfg(feature = "trace")]
        let _app_run_guard = app_run_span.enter();
