...
/// Converts `AssetPathId` to `ResourceId`.
...
/// Converts `AssetPathId` through `ResourceId` to binary representation.
pub fn path_id_to_binary(path: &Option<AssetPathId>, asset_type: ResourceType) -> u128 {
