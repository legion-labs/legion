...
pub fn derive_enum_variant_meta(input: TokenStream) -> TokenStream {
    ...
    let lgn_util_path = LegionManifest::default().get_path(crate::modules::LEGION_UTILS);
    ...
    TokenStream::from(quote! {
        impl #impl_generics #lgn_util_path::EnumVariantMeta for #struct_name #ty_generics #where_clause {
