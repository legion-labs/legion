 ...
 */
const methodDescriptor_PerformanceAnalytics_list_process_log_entries = new grpc.web.MethodDescriptor(
  '/analytics.PerformanceAnalytics/list_process_log_entries',
  grpc.web.MethodType.UNARY,
  proto.analytics.ProcessLogRequest,
  proto.analytics.ProcessLogReply,
  /**
   * @param {!proto.analytics.ProcessLogRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.analytics.ProcessLogReply.deserializeBinary
);


/**
 * @param {!proto.analytics.ProcessLogRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.analytics.ProcessLogReply)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.analytics.ProcessLogReply>|undefined}
 *     The XHR Node Readable Stream
 */
proto.analytics.PerformanceAnalyticsClient.prototype.list_process_log_entries =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/analytics.PerformanceAnalytics/list_process_log_entries',
      request,
      metadata || {},
      methodDescriptor_PerformanceAnalytics_list_process_log_entries,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.analytics.ProcessLogReply>}
 *     Promise that resolves to the response
 */
proto.analytics.PerformanceAnalyticsPromiseClient.prototype.list_process_log_entries =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/analytics.PerformanceAnalytics/list_process_log_entries',
      request,
