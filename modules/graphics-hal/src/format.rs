...
//!
//! `graphics-hal` splits a `Format` into two sub-components, a `SurfaceType` and
...
pub use crate::external_memory::DrmModifier;
...
impl Swizzle {
    ...
    pub const NO: Self = Self(Component::R, Component::G, Component::B, Component::A);
}
