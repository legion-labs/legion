...
pub fn map_component(component: format::Component) -> vk::ComponentSwizzle {
    match component {
        format::Component::Zero => vk::ComponentSwizzle::ZERO,
        format::Component::One => vk::ComponentSwizzle::ONE,
        format::Component::R => vk::ComponentSwizzle::R,
        format::Component::G => vk::ComponentSwizzle::G,
        format::Component::B => vk::ComponentSwizzle::B,
        format::Component::A => vk::ComponentSwizzle::A,
    }
}
...
pub fn map_attachment_load_op(op: pass::AttachmentLoadOp) -> vk::AttachmentLoadOp {
    use crate::pass::AttachmentLoadOp as Alo;
    match op {
...
pub fn map_attachment_store_op(op: pass::AttachmentStoreOp) -> vk::AttachmentStoreOp {
    use crate::pass::AttachmentStoreOp as Aso;
    match op {
...
pub fn map_wrap(wrap: image::WrapMode) -> vk::SamplerAddressMode {
    use crate::image::WrapMode as Wm;
    match wrap {
...
pub fn map_reduction(reduction: image::ReductionMode) -> vk::SamplerReductionMode {
    use crate::image::ReductionMode as Rm;
    match reduction {
...
pub fn map_comparison(fun: pso::Comparison) -> vk::CompareOp {
    match fun {
        pso::Comparison::Never => vk::CompareOp::NEVER,
        pso::Comparison::Less => vk::CompareOp::LESS,
        pso::Comparison::LessEqual => vk::CompareOp::LESS_OR_EQUAL,
        pso::Comparison::Equal => vk::CompareOp::EQUAL,
        pso::Comparison::GreaterEqual => vk::CompareOp::GREATER_OR_EQUAL,
        pso::Comparison::Greater => vk::CompareOp::GREATER,
        pso::Comparison::NotEqual => vk::CompareOp::NOT_EQUAL,
        pso::Comparison::Always => vk::CompareOp::ALWAYS,
    }
}

pub fn map_stencil_op(op: pso::StencilOp) -> vk::StencilOp {
    match op {
        pso::StencilOp::Keep => vk::StencilOp::KEEP,
        pso::StencilOp::Zero => vk::StencilOp::ZERO,
        pso::StencilOp::Replace => vk::StencilOp::REPLACE,
        pso::StencilOp::IncrementClamp => vk::StencilOp::INCREMENT_AND_CLAMP,
        pso::StencilOp::IncrementWrap => vk::StencilOp::INCREMENT_AND_WRAP,
        pso::StencilOp::DecrementClamp => vk::StencilOp::DECREMENT_AND_CLAMP,
        pso::StencilOp::DecrementWrap => vk::StencilOp::DECREMENT_AND_WRAP,
        pso::StencilOp::Invert => vk::StencilOp::INVERT,
    }
}
...
pub fn map_blend_factor(factor: pso::Factor) -> vk::BlendFactor {
    use crate::pso::Factor as PF;
    match factor {
        PF::Zero => vk::BlendFactor::ZERO,
        PF::One => vk::BlendFactor::ONE,
        PF::SrcColor => vk::BlendFactor::SRC_COLOR,
        PF::OneMinusSrcColor => vk::BlendFactor::ONE_MINUS_SRC_COLOR,
        PF::DstColor => vk::BlendFactor::DST_COLOR,
        PF::OneMinusDstColor => vk::BlendFactor::ONE_MINUS_DST_COLOR,
        PF::SrcAlpha => vk::BlendFactor::SRC_ALPHA,
        PF::OneMinusSrcAlpha => vk::BlendFactor::ONE_MINUS_SRC_ALPHA,
        PF::DstAlpha => vk::BlendFactor::DST_ALPHA,
        PF::OneMinusDstAlpha => vk::BlendFactor::ONE_MINUS_DST_ALPHA,
        PF::ConstColor => vk::BlendFactor::CONSTANT_COLOR,
        PF::OneMinusConstColor => vk::BlendFactor::ONE_MINUS_CONSTANT_COLOR,
        PF::ConstAlpha => vk::BlendFactor::CONSTANT_ALPHA,
        PF::OneMinusConstAlpha => vk::BlendFactor::ONE_MINUS_CONSTANT_ALPHA,
        PF::SrcAlphaSaturate => vk::BlendFactor::SRC_ALPHA_SATURATE,
        PF::Src1Color => vk::BlendFactor::SRC1_COLOR,
        PF::OneMinusSrc1Color => vk::BlendFactor::ONE_MINUS_SRC1_COLOR,
        PF::Src1Alpha => vk::BlendFactor::SRC1_ALPHA,
        PF::OneMinusSrc1Alpha => vk::BlendFactor::ONE_MINUS_SRC1_ALPHA,
    }
}
...
pub fn map_memory_range((memory, segment): (&n::Memory, Segment)) -> vk::MappedMemoryRange {
...
pub fn map_view_kind(
    ...
    use super::vk::ImageType;
    use crate::image::ViewKind;

    Some(match (ty, kind) {
        (ImageType::TYPE_1D, ViewKind::D1) => vk::ImageViewType::TYPE_1D,
        (ImageType::TYPE_1D, ViewKind::D1Array) => vk::ImageViewType::TYPE_1D_ARRAY,
        (ImageType::TYPE_2D, ViewKind::D2) => vk::ImageViewType::TYPE_2D,
        (ImageType::TYPE_2D, ViewKind::D2Array) => vk::ImageViewType::TYPE_2D_ARRAY,
        (ImageType::TYPE_3D, ViewKind::D3) => vk::ImageViewType::TYPE_3D,
        (ImageType::TYPE_2D, ViewKind::Cube) if is_cube => vk::ImageViewType::CUBE,
        (ImageType::TYPE_2D, ViewKind::CubeArray) if is_cube => vk::ImageViewType::CUBE_ARRAY,
        (ImageType::TYPE_3D, ViewKind::Cube) if is_cube => vk::ImageViewType::CUBE,
        (ImageType::TYPE_3D, ViewKind::CubeArray) if is_cube => vk::ImageViewType::CUBE_ARRAY,
        _ => return None,
    })
}
...
pub fn map_vk_memory_properties(flags: vk::MemoryPropertyFlags) -> crate::memory::Properties {
...
pub fn map_vk_memory_heap_flags(flags: vk::MemoryHeapFlags) -> crate::memory::HeapFlags {
    use crate::memory::HeapFlags;
