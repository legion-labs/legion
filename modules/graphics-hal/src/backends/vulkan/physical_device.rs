...
use std::{ffi::CStr, fmt, mem, panic, ptr, sync::Arc};
...
impl PhysicalDeviceFeatures {
    ...
    /// Get the `crate::Features` corresponding to the raw physical device's features and properties.
...
impl PhysicalDeviceInfo {
    ...
    fn get_required_extensions(&self, requested_features: Features) -> Vec<&'static CStr> {
        let mut requested_extensions = vec![Swapchain::name()];
    ...
    fn load(
            ...
            instance.get_physical_device_properties
        {
            ...
            if device_properties.api_version() >= Version::V1_2 {
                ...
                mut_ref.p_next = mem::replace(
                    &mut features2.p_next,
                    (mut_ref as *mut vk::PhysicalDeviceVulkan12Features).cast(),
                );
            }
            ...
            if device_properties.supports_extension(vk::ExtDescriptorIndexingFn::name()) {
                ...
                mut_ref.p_next = mem::replace(
                    &mut features2.p_next,
                    (mut_ref as *mut vk::PhysicalDeviceDescriptorIndexingFeaturesEXT).cast(),
                );
            }
            ...
            if device_properties.supports_extension(MeshShader::name()) {
                ...
                mut_ref.p_next = mem::replace(
                    &mut features2.p_next,
                    (mut_ref as *mut vk::PhysicalDeviceMeshShaderFeaturesNV).cast(),
                );
            }
            ...
            if device_properties.supports_extension(vk::KhrImagelessFramebufferFn::name()) {
                ...
                mut_ref.p_next = mem::replace(
                    &mut features2.p_next,
                    (mut_ref as *mut vk::PhysicalDeviceImagelessFramebufferFeaturesKHR).cast(),
                );
            }
...
/// Physical Device, equivalent to an adapter
...
impl adapter::PhysicalDevice<Backend> for PhysicalDevice {
    ...
    fn format_properties(&self, format: Option<format::Format>) -> format::Properties {
        ...
        let properties = unsafe {
            match self.instance.get_physical_device_properties {
                None => self.instance.inner.get_physical_device_format_properties(
                    self.handle,
                ...
                Some(ref extension) => {
                    ...
                    format_properties2.format_properties
                }
            }
        };
    ...
    fn properties(&self) -> PhysicalDeviceProperties {
        ...
        let mut descriptor_indexing_capabilities = crate::DescriptorIndexingProperties::default();
        let mut mesh_shader_capabilities = crate::MeshShaderProperties::default();
        let mut sampler_reduction_capabilities = crate::SamplerReductionProperties::default();
        let mut external_memory_limits = crate::ExternalMemoryLimits::default();
            ...
            self.instance.get_physical_device_properties.as_ref()
        {
            ...
            descriptor_indexing_capabilities = crate::DescriptorIndexingProperties {
            ...
            mesh_shader_capabilities = crate::MeshShaderProperties {
            ...
            sampler_reduction_capabilities = crate::SamplerReductionProperties {
    ...
    unsafe fn enumerate_displays(&self) -> Vec<display::Display<Backend>> {
        ...
        for display_property in display_properties {
            let supported_transforms = crate::display::SurfaceTransformFlags::from_bits(
    ...
    unsafe fn create_display_mode(
        ...
        match display_extension.create_display_mode(
            ...
            Err(vk::Result::ERROR_INITIALIZATION_FAILED) => {
                Err(display::DisplayModeError::UnsupportedDisplayMode)
            }
    ...
    unsafe fn create_display_plane<'a>(
        ...
        let display_plane_capabilities = match display_extension.get_display_plane_capabilities(
            ...
            Err(vk::Result::ERROR_OUT_OF_HOST_MEMORY) => return Err(OutOfMemory::Host),
            Err(vk::Result::ERROR_OUT_OF_DEVICE_MEMORY) => return Err(OutOfMemory::Device),
            Err(err) => panic!(
