...
impl com::CommandBuffer<Backend> for CommandBuffer {
    unsafe fn begin(
        ...
        info: com::CommandBufferInheritanceInfo<'_, Backend>,
    ) {
    ...
    unsafe fn begin_query(&mut self, query: query::Query<'_, Backend>, flags: query::ControlFlags) {
    ...
    unsafe fn end_query(&mut self, query: query::Query<'_, Backend>) {
        self.device
            .raw
    ...
    unsafe fn push_graphics_constants(
        ...
        self.device.raw.cmd_push_constants(
            ...
            offset,
            slice::from_raw_parts(constants.as_ptr().cast(), constants.len() * 4),
        );
    }
