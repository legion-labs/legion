...
impl BlendOp {
    ...
    pub const REPLACE: Self = Self::Add {
        src: Factor::One,
        dst: Factor::Zero,
    };
    ...
    pub const ALPHA: Self = Self::Add {
        src: Factor::SrcAlpha,
        dst: Factor::OneMinusSrcAlpha,
    };
    /// Alpha blend a premultiplied-alpha source with the destination.
    pub const PREMULTIPLIED_ALPHA: Self = Self::Add {
        src: Factor::One,
        dst: Factor::OneMinusSrcAlpha,
    };
}
